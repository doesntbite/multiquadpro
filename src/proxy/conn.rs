...
// Rekomendasi untuk Cloudflare Workers
static MAX_WEBSOCKET_SIZE: usize = 128 * 1024;  // 128kb (maksimal yang didukung)
static MAX_BUFFER_SIZE: usize = 4 * 1024 * 1024; // 4MB (cukup untuk kebanyakan kasus)
